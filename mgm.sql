...
('default', 'ClientStack.LindenCaps', 'Cap_GetTexture', 'localhost'),
('default', 'ClientStack.LindenCaps', 'Cap_GetMesh', 'localhost'),
...
('default', 'FreeSwitchVoice', 'FreeswitchServiceURL', 'http://107.7.21.240/server/fsapi'),
